...
//		User user=(User)request.getAttribute("user");
        ...
        if(puanduan.equals("yes")&&book.getBook_state().equals("�ɽ�")) {
            Record record=new Record(book.getBook_name(),book.getBook_ISBN(),user.getUser_name(),str1,str2,"δ��","��ԤԼ");
            try {
                ...
                if(record2!=null) {
                    ...
                    dao2.Modify2(book.getBook_ISBN(),"�ѽ��");

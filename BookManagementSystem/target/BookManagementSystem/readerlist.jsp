...
<div class="container">
    ...
    <div style="float: right;margin: 5px;">
        ...
        <a class="btn btn-primary" href="${pageContext.request.contextPath}/record.jsp">查看我的借阅</a>
        ...
        <table border="1" class="table table-bordered table-hover">
            ...
            <c:forEach items="${pb.list}" var="book" varStatus="s">
                <tr>
                    ...
                    <td>${book.bookCode}</td>
                    <td>${book.counts}</td>
                    <td><a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/book/borrowBook?bid=${book.bid}">借阅</a></td>
                </tr>
